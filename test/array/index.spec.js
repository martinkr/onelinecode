...
test('exports a function "(arr.)clean"', t => {
    t.true(typeof (arr.clean) === 'function')
});

test('exports a function "(arr.)cleanFalsy"', t => {
    t.true(typeof (arr.cleanFalsy) === 'function')
});

test('exports a function "(arr.)sum"', t => {
    t.true(typeof (arr.sum) === 'function')
});

test('exports a function "(arr.)average"', t => {
    t.true(typeof (arr.average) === 'function')
});

test('exports a function "(arr.)nthItems"', t => {
    t.true(typeof (arr.nthItems) === 'function')
});

test('exports a function "(arr.)sortAsc"', t => {
